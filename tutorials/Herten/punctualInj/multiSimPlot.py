...
for i in range(1, 2):
    os.chdir('/home/pmxep5/OpenFOAM/others/GMRTFoam/tutorials/simpleDarcyFoam/RESULTS/Herten/punctualInj')
    dd = []
    cl = []
    mass = []
    mvel = []
