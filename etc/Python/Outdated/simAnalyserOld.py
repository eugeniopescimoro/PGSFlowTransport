...
axs1[0, 1].set_xlabel('$t/t* [-]$')
axs1[0, 1].set_ylabel('$dc/dt [-]$')
axs1[1, 0].set_xlabel('$t/t* [-]$')
axs1[1, 0].set_ylabel('$c [-]$')
axs1[1, 1].set_xlabel('$t/t* [-]$')
axs1[1, 1].set_ylabel('$1-c [-]$')
...
handles, labels = axs1[1, 1].get_legend_handles_labels()
fig1.legend(handles, labels, loc = 'lower center', ncol=10, prop={'size': 6})
# Adjust visualization, save and show plots
plt.tight_layout()
os.makedirs(os.path.join(luin67272TS, "../images"), exist_ok = True)
fig1.savefig(os.path.join(luin67272TS, "../images/BTCmoment.pdf"))
